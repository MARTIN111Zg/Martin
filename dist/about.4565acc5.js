...
},{"_css_loader":"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"js/navhanler.js":[function(require,module,exports) {
var navhandler = function navhandler() {
  var btn = document.querySelector(".nav__btn");
  var menu = document.querySelector(".nav__overlay__wrapper");
  var links = document.querySelector(".nav__ul");
  var lina = document.querySelectorAll(".nav__links");
  btn.addEventListener("click", function () {
    menu.classList.toggle("active");
    setTimeout(function () {
      links.classList.toggle("active");
    }, 200);
    lina.forEach(function (lin, index) {
      lin.style.animation = "movelink 1s ease  ".concat(index / 8, "s");
    });
...
},{"process":"../../AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"js/pagetransition.js":[function(require,module,exports) {
"use strict";
